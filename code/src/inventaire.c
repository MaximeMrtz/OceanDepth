...
void afficher_inventaire_avance(Inventaire *inv) {
    ...
    printf("+----------------+----------------+----------------+\n");
    printf("| Harpon: %-8s | Combi: %-8s | Perles: %-4d |\n",
...
// J'affiche les equipements actuels
...
// Fonction pour liberer l'inventaire (pour l'instant rien a faire)
...
int ajouter_objet(Inventaire *inv, Objet objet) {
    // Je verifie si l'objet existe deja (pour les consommables)
